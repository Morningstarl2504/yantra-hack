...
// GET /api/auth/me  — returns full user including quiz history
...
// PATCH /api/auth/quiz-result  — save one quiz question result
const saveQuizResult = async (req, res) => {
  try {
    const { topic, score, difficulty } = req.body
    await User.findByIdAndUpdate(req.user._id, {
      $push: { quizHistory: { topic, score, difficulty, date: new Date() } }
    })
